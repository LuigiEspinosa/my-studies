...
started: 2025-03-17
finished: 2025-03-17
tags: [engage, clm, content-strategy, user-experience]
code: []
kind: note
---
...
| **Images** | `.jpg` `.png`  | - Full screen - landscape. - If resolution larger than display, pinch zooming allowed.` | Should be smallest resolution and compressed as much as possible without impacting quality (max: 1499x2499).                                                                       |
...
> [!TIP]- Content must be sourced from \_\_ to be available in the CRM Engage Application on Windows PCs.
>
> Veeva Vault PromoMats.

---

> [!TIP]- AR content is supported in Engage Meeting.
>
> False.

---

> [!TIP]- Only some CLM JavaScript Library functions can be used in CLM Presentations presented in Engage Meeting hosted on Windows PCs (via CRM Online).
>
> True.

---

> [!TIP]- Before creating or adapting CLM content for Engage Meeting:
>
> - Review the Engage Meeting Content Suitability Checklist.
> - Test content to determine if updates are required.
