<<<<<<< HEAD
<<<<<<<< HEAD:Veeva Learning/CLM Business Certification v5/Veeva CLM Presentation Advanced Features.md
=======
>>>>>>> main
...
When updating a Shared Resource, the update affects all content where the Shared Resource is currently in use.
>>>>>>>> main:Veeva Learning/CLM Business Certification v4/Veeva CLM Presentation Advanced Features.md
=======
>>>>>>> main
