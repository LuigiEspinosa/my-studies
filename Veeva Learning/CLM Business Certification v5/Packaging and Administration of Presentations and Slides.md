<<<<<<<< HEAD:Veeva Learning/CLM Business Certification v5/Packaging and Administration of Presentations and Slides.md
## Terms to Know
...
[^1]: If the CLM Admin tab isn't visible all Tabs in CRM can be accessed via clicking the '+' button.
>>>>>>>> main:Veeva Learning/CLM Business Certification v4/Packaging and Administration of Presentations and Slides.md
