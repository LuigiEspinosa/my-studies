...
> [!TIP]- In ASP.NET Core, what is the name of the file where we store any settings specific to the production environment?
>
> `appsettings.Production.json`

---

> [!TIP]- What were the reasons for our ASP.NET Core backend needing the `Frontend` setting?
>
...
> [!NOTE] Let's pretend we have introduced a QA environment and have created the following `npm` script to do a build for this environment:
>
...
> [!TIP]- Why didn't we use Azure Storage to host our frontend rather than Azure App Service?
>
